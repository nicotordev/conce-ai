...
.word-break-break-word {
  ...
  <body class="m-0 p-0 w-full word-break-break-word -webkit-font-smoothing-antialiased" cz-shortcut-listen="true">
      ...
      <tr>
        <td class="p-6">
          ...
          <p class="text-gray-600">
            Estás a un paso de comenzar a usar <strong>Cóndor-AI</strong>. Para
            activar tu cuenta y garantizar la seguridad de tus datos,
          ...
          <div class="bg-gray-50 p-4 border border-blue-300 rounded-lg text-center my-4">
            ...
            <a href="${ verificationUrl }" class="inline-block mt-3 px-6 py-2 bg-gray-900 text-white rounded text-sm font-semibold">Verificar mi correo electrónico</a>
          ...
          <div class="bg-blue-100 border-l-4 border-gray-900 p-4 rounded-lg">
            ...
            <ul class="list-disc pl-5 text-gray-600">
              <li>Ingresa a la página de verificación de Cóndor-AI</li>
          ...
          <p class="text-gray-600 mt-4">
            ...
            funcionalidades de Cóndor-AI.
          </p>
          <p class="text-gray-600">
            Si no solicitaste esta cuenta o tienes alguna pregunta, ignora este
            correo o contáctenos.
          </p>
